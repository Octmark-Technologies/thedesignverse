    ...
    <div style={{ position: 'fixed', bottom: '1.5rem', right: '1.5rem', zIndex: 9999, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.5rem' }}>
      ...
      <motion.a
        ...
        style={{
          ...
          boxShadow: '0 4px 20px rgba(206,212,129,0.4)',
          textDecoration: 'none',
          cursor: 'pointer',
          marginBottom: '0.2rem',
        }}
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0f1e29" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
